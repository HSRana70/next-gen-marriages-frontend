...
export default function GuestRegisterPage() {
  ...
  const handleSubmit = (e) => {
    ...
    alert('Guest registration submitted!');
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="mt-4 space-y-2">
              ...
              <label className="flex items-center space-x-2">
                <input type="radio" name="attendedBefore" value="Yes" checked={formData.attendedBefore === 'Yes'} onChange={handleChange} />
                <span>Yes</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="radio" name="attendedBefore" value="No" checked={formData.attendedBefore === 'No'} onChange={handleChange} />
                <span>No</span>
              </label>
            </div>
          ...
          <div>
            ...
            <div className="mt-4 space-y-2">
              ...
              <label className="flex items-center space-x-2">
                <input type="radio" name="travelArranged" value="Yes" checked={formData.travelArranged === 'Yes'} onChange={handleChange} />
                <span>Yes</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="radio" name="travelArranged" value="No" checked={formData.travelArranged === 'No'} onChange={handleChange} />
                <span>No</span>
              </label>
            </div>
            ...
            <div className="mt-4 space-y-2">
              ...
              <label className="flex items-center space-x-2">
                <input type="radio" name="needAssistance" value="Yes" checked={formData.needAssistance === 'Yes'} onChange={handleChange} />
                <span>Yes</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="radio" name="needAssistance" value="No" checked={formData.needAssistance === 'No'} onChange={handleChange} />
                <span>No</span>
              </label>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <label className="flex items-center space-x-2">
                <input type="radio" name="paidExperience" value="Yes" checked={formData.paidExperience === 'Yes'} onChange={handleChange} />
                <span>Yes</span>
              </label>
              <label className="flex items-center space-x-2">
                <input type="radio" name="paidExperience" value="No" checked={formData.paidExperience === 'No'} onChange={handleChange} />
                <span>No</span>
              </label>
            </div>
